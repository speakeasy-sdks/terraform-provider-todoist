...
var ServerList = []string{
	// Todoist REST API v2 server URL
...
// SDK - Todoist_REST_V2: Todoist for ChatGPT
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.338.14",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.338.14 1.1.0 github.com/speakeasy/terraform-provider-todoist/internal/sdk",
			Hooks:             hooks.New(),
		},
	}
	...
	sdk.Sections = newSections(sdk.sdkConfiguration)

	sdk.Tasks = newTasks(sdk.sdkConfiguration)

	sdk.Comments = newComments(sdk.sdkConfiguration)
